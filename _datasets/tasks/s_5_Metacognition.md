...
![]({{ BASE_PATH }}/assets/images/datasets/i_s_5_Metacognition_1.png)
...
1. Mazor, M., Friston, K. J., & Fleming, S. M. (2020). Distinct neural contributions to metacognition for detecting, but not discriminating visual stimuli. ELife, 9, e53900.