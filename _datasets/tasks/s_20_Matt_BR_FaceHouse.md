...
email:
ratings: false
summary: Green/Red gratings for binocular rivalry. The gratings are flickering at two different frequencies. Intermittent sound snipets have one of the flickering frequencies.
participants:
...
Binocular rivarly / FaceHouse on multimodal integration, using multiple flickering blocks.
...
![]({{ BASE_PATH }}/assets/images/datasets/i_s_20_Matt_BR_FaceHouse_1.png)
